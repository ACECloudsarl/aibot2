...
// Import Feathers client and AuthContext
...
export default function RegisterPage() {
  ...
  // Use the AuthContext for registration
  ...
  const handleRegister = async (e) => {
    ...
    try {
      // Use the register method from AuthContext (which uses Feathers)
  ...
  const handleOAuthSignIn = (provider) => {
    setIsLoading(true);
    // TODO: Implement Feathers OAuth login
    toast.info(`${provider} login will be implemented with Feathers`);
    setIsLoading(false);
  };
