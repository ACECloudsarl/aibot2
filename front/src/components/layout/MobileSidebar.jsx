...
import { 
  ...
  BookOpen, Keyboard, ChevronDown, X
} from "lucide-react";
...
export default function MobileSidebar({ 
  ...
  // Top 5 featured models with icons (same as desktop)
        ...
        <div className="flex flex-col h-full">
          <SheetHeader className="p-4 border-b flex-row items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <SheetTitle className="text-xl">AI Chat</SheetTitle>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="px-3 py-2">
            ...
            <div className="flex border rounded-md overflow-hidden mt-2">
              <Button 
                variant="ghost" 
                className="flex-1 rounded-none border-r h-8 text-xs px-2"
                onClick={() => handleNavigation(chatList.length > 0 ? `/c/${chatList[0].id}` : "/")}
              >
              ...
              <Button 
                variant="ghost" 
                className="flex-1 rounded-none h-8 text-xs px-2"
